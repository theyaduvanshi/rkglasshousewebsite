      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              <li>
                ...
                <a
                  href="https://www.google.com/maps/place/R.K.GLASS+HOUSE/@26.7985455,75.7334563,17z/data=!3m1!4b1!4m6!3m5!1s0x396dcabf12b4f135:0x74a91518bb529004!8m2!3d26.7985455!4d75.7334563!16s%2Fg%2F11vk0jdjk5"
                  className="hover:text-[var(--color-brand-yellow)] transition-colors"
                >
                  Shop no. 2, Plot no. 7, Mandi Rd, Near SMS Colony, Muhana,
                  Rajasthan 302029
                </a>
              </li>
              ...
              <li>
                ...
                <a
                  ...
                  className="hover:text-[var(--color-brand-yellow)] transition-colors break-all"
                >
                  rkglasshousemuhana@gmail.com
                </a>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 mt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            © {new Date().getFullYear()} RK Glass House. All rights reserved.
          </p>
